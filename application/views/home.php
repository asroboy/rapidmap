...
<html lang="en">
  ...
  <body id="page-top">
        ...
        <div class="intro-text">
          ...
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#info">Info Lebih Lanjut</a>
            ...
            <div class="logo-member">
      			  <div class="img-logo">
        				<a href="www.big.go.id/" target="_blank"><img class="mx-auto rounded-circle" src="assets/land-page/images/logos/1.png" alt=""></a> &nbsp;&nbsp;
        				<a href="https://www.bmkg.go.id/" target="_blank"><img class="mx-auto rounded-circle" src="assets/land-page/images/logos/2.png" alt=""></a> &nbsp;&nbsp;
        				<a href="https://bnpb.go.id/" target="_blank"><img class="mx-auto rounded-circle" src="assets/land-page/images/logos/3.png" alt=""></a> &nbsp;&nbsp;
        				<a href="https://www.pu.go.id/" target="_blank"><img class="mx-auto rounded-circle" src="assets/land-page/images/logos/4.png" alt=""></a> &nbsp;&nbsp;
        				<a href="https://www.migas.esdm.go.id/" target="_blank"><img class="mx-auto rounded-circle" src="assets/land-page/images/logos/5.png" alt=""></a>
      			  </div>
			     </div>
		      </div>
    ...
    <!-- Fitur -->
    <div class="section-info" style="background-color: #e4e4e4" id="info">
    <!--<section class="bg-light" id="fitur">-->
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">FITUR - FITUR</h2><br>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="team-member">
              ...
              <h4><a href="dashboard.html" target="_blank">DASHBOARD PETA BENCANA</a></h4>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/land-page/images/team/2.png" alt="">
              <h4><a href="login.html" target="_blank">ANALISIS SPASIAL</a></h4>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/land-page/images/team/3.png" alt="">
              <h4><a href="https://petakita.big.go.id/" target="_blank">PETA KITA</a></h4>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-8">
            <?php foreach($berita as $item) { ?>
              ...
              <div class="text-muted" style="text-align:justify;line-height: 25px;padding-top: 10px;padding-bottom:10px">
  			      ...
  			      <a href="<?php echo(base_url().'berita/view/'.$item[0].'.html')?>" style="color:blue;line-height: 10px;font-size:11pt">Baca Selengkapnya ...</a>
            <?php } ?>
          </div>
          <div class="col-md-4">
          <?php foreach ($listberita as $item) { ?>
            <?php if($item[0] !== $max){?>
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="header-news-1"><a href="<?php echo (base_url().'berita/view/'.$item[0].'.html')?>"><?php echo $item[1]; ?></a></div>
